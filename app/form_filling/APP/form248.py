...
from PyPDF2_Fields import make_writer_from_reader, update_page_fields, PdfFieldType, \
...
class Form248:
    ...
    def write_to_file(self, data):
        ...
        content = {
            ...
            "txtbuyersig2": data.get('buyer_sig2'),
            # "DISCLAIMER": data.get('disclaimer', "test dis")
        }

        self.writer.updatePageFormFieldValues(self.writer.getPage(16), content)
        ...
        get_write_page(self.output_file_path, 16)
